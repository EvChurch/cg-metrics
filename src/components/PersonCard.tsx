  ...
  return (
    <div className="flex flex-col rounded-2xl border-2 border-[#DDDDDD] bg-white py-6 px-9 shadow-[2px_2px_14px_0_rgba(0,0,0,0.05)]">
      ...
      <div className="mt-6 flex justify-center">
        <a
          href="#"
          className="inline-flex items-center justify-center rounded-full border-2 border-[#E22A30] px-5 py-2 text-sm font-medium text-[#E22A30] hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500/50">
          View Stats
        </a>
      </div>
    </div>
